...
import { Browser, BrowserState } from '@components/Browser/browser';
import { useInterval } from '../hooks/useInterval';
import { changeThemeOnScrollPosition } from '../lib/theme';
import { animateSectionsOnScroll } from 'lib/animations';

export default function Home() {
  const [browserScreen, setBrowserScreen] = useState<BrowserState>('idle');

  useEffect(changeThemeOnScrollPosition, []);
  useEffect(animateSectionsOnScroll(browserScreen, setBrowserScreen), []);
