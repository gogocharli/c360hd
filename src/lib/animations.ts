...
export function animateSectionsOnScroll(
  ...
  return () => {
    ...
    ScrollTrigger.matchMedia({
      '(max-width: 50em) and (prefers-reduced-motion: no-preference)':
        function () {
          ...
          const journeyScene =
            document.querySelector<HTMLDivElement>('#journey .scene');
          ...
          const carouselContainer =
            document.querySelector<HTMLElement>('.panel__container');
      ...
      '(min-width: 50em) and (max-width: 65em) and (prefers-reduced-motion: no-preference)':
        function () {
          const journeyTimeline = gsap.timeline({
            scrollTrigger: {
              trigger: '#journey',
          ...
          gsap.to(carouselCards, {
            ...
            scrollTrigger: {
              ...
              pin: true,
              snap: 0.5,
              end: () => '+=' + (carouselContainer?.offsetWidth ?? 0 + 60),
            },
          });
        },

      '(min-width: 65em) and (prefers-reduced-motion: no-preference)':
        function () {
